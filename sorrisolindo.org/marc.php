...
<body>
   <div id="interface">
     <div id="slideBar">
         <div></div>
         <div><button class="btn btn-primary form-control btn_slide" id="marcacao"><i><img src="icones/add_user_male_40px.png"></i>  Cadastrar Pacientes</button></div>
       ...
       <div id="conteudo">
           <div id="perfil">
               ...
               <div class="abas" id="foto"><img style="border-radius:35px " width="25%" src="<?php  echo $foto ?>">
               </div>

       </div>
           <iframe id="abas" src="dashboard_marc.php" width="100%" height="600px">
