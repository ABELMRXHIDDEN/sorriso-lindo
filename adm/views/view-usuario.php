...
<div class="main">
    ...
    <dialog class="view" style="height: 95%;">

        <div class="modal-header">
            <h4 id="tituloModal" class="modal-title align-content-center">Adicionar Funcionário</h4>
        ...
        <form class="gridf">
           <div class="item" id="col_nome">
            ...
            <div class="item" id="col_salario">
                <div class="form-floating w-100">
                    <input type="number" class="form-control texto" id="Salario">
                    <label>Salário</label>
                </div>
            </div>
            <div class="item" id="col_cargo">
                <div class="form-floating w-100">
                <select class="form-control form-select texto" id="Cargo">
                    <option value="Recepcao">Recepcionista</option>
                    <option value="Dentista">Denstista</option>
                    <option value="Adm">Administrador</option>
                </select>
                    <label>Cargo</label>
                </div>
            </div>
            <div class="item" id="col_senha">
                <div class="form-floating w-100">
                <input class="form-control texto" placeholder="salario" id="Senha">
                    <label>Senha</label>
                </div>
            </div>
